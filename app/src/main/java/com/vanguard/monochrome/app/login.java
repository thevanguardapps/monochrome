...
login extends AppCompatActivity implements View.OnClickListener,View.OnKeyListener {
    ...
    public void loginFunction() {
        final String username=usernameFieldInLogIn.getText().toString().trim();
        final String password=passwordFieldInLogIn.getText().toString().trim();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logInbtn.setOnClickListener(this); //Login Button
